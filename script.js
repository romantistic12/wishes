/* ============================================================
   CUSTOMIZE HERE
   ============================================================ */
const RECIPIENT_NAME = "Jabbar Ahmed"; // e.g. "Sarah" — used in the wish text below
...
Happy birthday,Jaybeeee. Thank you for being you. I'm so lucky to have you in my life.`;
...
function typeWriter(text, el, speed = 28, onComplete) {
  let i = 0;
  function step() {
    if (i <= text.length) {
...
function transitionToFinale() {
  // let the letter sit on screen for a while after typing finishes,
  // then blur it out and bring the finale card in
  setTimeout(() => {
...
function openLetter() {
  ...
  setTimeout(() => {
    ...
    typeWriter(WISH_TEXT, typedEl, 28, transitionToFinale);
