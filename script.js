/* ============================================================
   CUSTOMIZE HERE
   ============================================================ */
const RECIPIENT_NAME = "you"; // e.g. "Sarah" — used in the wish text below
...
Happy birthday, ${RECIPIENT_NAME}. Thank you for being you. I'm so lucky to have you in my life.`;
...
const CUSTOM_AUDIO_PATH = "song.mp3"; // rename to match your actual mp3 filename
